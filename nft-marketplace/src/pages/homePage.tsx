...
function TrendingCollection() {
  ...
  {console.log(trendingItemTwo.smallImages[0])}
  {console.log(trendingItemOne.smallImages[0])}
  ...
  return (
    <section className="container  mx-auto px-6 py-6 max-w-sm md:max-w-3xl xl:max-w-5xl">
      <div className="flex flex-col gap-2 py-5 md:py-10 xl:py-20">
        <h2 className="text-2xl md:text-3xl xl:text-5xl font-bold">Trending Collection</h2>
    ...
    <div className="container py-5 xl:py-1">
      ...
      <div className="container py-5 xl:py-1">
        ...
        <div className="flex flex-col gap-2 px-4 py-3">
          ...
          <div className="name&logo flex align-center gap-2">
            <img src={trendingItemThree.avatarIcon} alt="logo" className="size-6" />
